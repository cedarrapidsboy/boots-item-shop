...
public class ArmorFactory {
    ...
    /**
     *
     * @param armorValue An integer representing the protection this item provides
     * @param encumbrance A double representing this item's weight
     * @param condition A double representing a percentage of the items durability
     * @param durability An int representing the durability of the item
     * @return Boot
     */
    ...
    /**
     * Get a random boot with random stats
     * armorValue 0-5
     * encumbrance 0.1-1.0
     * durability 3-10
     * @return Boot
